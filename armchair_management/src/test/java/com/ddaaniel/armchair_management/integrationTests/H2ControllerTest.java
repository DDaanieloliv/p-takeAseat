...
public class H2ControllerTest {
	...
	@Autowired
	public H2ControllerTest(MockMvc mockMvc, SeatController seatController, ISeatRepository seatRepository,
			IPersonRepository personRepository, ServiceSeatImpl serviceSeat, ServicePersonImpl servicePerson) {
